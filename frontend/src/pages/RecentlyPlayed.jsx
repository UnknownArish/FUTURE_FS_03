...
export default function RecentlyPlayed() {
  ...
  const songs = [
    { 
      ...
      album: "Album X", 
      duration: "3:10", 
      image: "https://placehold.co/40x40/00CED1/FFFFFF?text=1",
    ...
    { 
      ...
      album: "Album Y", 
      duration: "3:55", 
      image: "https://placehold.co/40x40/00CED1/FFFFFF?text=2",
    ...
    { 
      ...
      album: "Album Z", 
      duration: "2:20", 
      image: "https://placehold.co/40x40/00CED1/FFFFFF?text=3",
  ...
  return (
    <div className="min-h-screen pb-32">
      <div className="relative pt-10 px-8 pb-6">
        <div className="absolute top-0 left-0 w-96 h-96 bg-blue-500 opacity-10 blur-[100px] -z-10 pointer-events-none"></div>
        
        <div className="flex items-end gap-6 mb-8">
          <div className="w-52 h-52 bg-gradient-to-br from-blue-700 to-cyan-500 flex items-center justify-center rounded-lg shadow-2xl">
